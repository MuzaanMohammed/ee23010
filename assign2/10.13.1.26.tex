...
\solution
\begin{align}
\text{Number of students in the class}&=n\brak{T}\\
&=23
\end{align}

W=selected student is not from A,B and C.

No of students in A,B and C=4+8+5=17
\begin{align}
n\brak{W}&=\text{Remaining no of students}\\
&=23-17\\
&=6\\
\pr{W}&=\frac{n\brak{W}}{n\brak{T}}\\
&=\frac{6}{23}
\end{align}
