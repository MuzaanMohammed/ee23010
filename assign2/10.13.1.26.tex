...
\begin{align} 
   \pr{{A^{\prime}}B^{\prime}C^{\prime}}= \pr{{\brak{A+B+C}^{\prime}}}\\
   \pr{{\brak{A+B+C}^{\prime}}}=1-\pr{\brak{A+B+C}}\\
   \pr{A+B+C}= \pr{A}+\pr{B}+\pr{C}\\
  \pr{A+B+C}=\frac{4}{23}+\frac{8}{23}+\frac{5}{23}=\frac{17}{23}\\
  \pr{A^{\prime}B^{\prime}C^{\prime}}=1-\frac{17}{23}=\frac{6}{23}
  \end{align}
